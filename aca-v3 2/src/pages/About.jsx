    ...
    <div className="font-body">
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
              ...
              <h2 style={{ fontFamily: "Playfair Display, serif", fontWeight: 600, fontSize: "clamp(22px,2.8vw,32px)", color: "#1A1A2E" }}>So we built the tool we wished we'd had.</h2>
            </div>
            <div style={{ width: 40, height: 2, background: "#B8860B", marginBottom: 24 }} />
      ...
      <section style={{ background: "#FAFAF7", padding: "96px 48px" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{ width: 48, height: 2, background: "#B8860B", margin: "0 auto 60px" }} />
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }}>
            {[
              ...
              { name: "Isabella", img: isabellaHeadshot, roles: ["Physics student.", "Previously computer engineering.", "Veteran architect of the platform."], focus: "Focused on building reliable systems that people can trust." },
            ].map(p => (
