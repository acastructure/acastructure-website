  ...
  return (
    <div style={{ background: "#000", overflowX: "hidden" }}>
      ...
      <section style={{ background: "#000", paddingTop: 80, paddingBottom: 0, textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 900, margin: "0 auto", padding: isMobile ? "0 24px" : "0 48px" }}>
        ...
        <div style={{ position: "relative", maxWidth: 860, margin: "0 auto", marginLeft: isMobile ? "5%" : "20%", marginRight: isMobile ? "5%" : "20%" }}>
      ...
      <section style={{ background: "#000", padding: isMobile ? "48px 24px" : "64px 48px", textAlign: "center", borderTop: "1px solid rgba(216,213,204,0.06)" }}>
