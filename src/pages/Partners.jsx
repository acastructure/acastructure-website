            ...
            {status === "sent" ? (
              <div style={{ textAlign: "center", padding: "48px 0" }}>
                <div style={{ width: 60, height: 60, borderRadius: "50%", background: "rgba(27,58,14,0.1)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
                  <svg width="26" height="26" fill="none" stroke="#5AE712" strokeWidth="2.5" viewBox="0 0 24 24"><path d="M20 6L9 17l-5-5"/></svg>
                </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <button onClick={handleSubmit} disabled={status === "sending"} style={{ fontFamily: "Inter, sans-serif", fontSize: 14, fontWeight: 600, color: "#fff", background: "#5AE712", border: "none", padding: "14px", borderRadius: 8, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
