  ...
  return (
    <div style={{ background: "#F2EFE8", minHeight: "100vh", color: "#1A1A18" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 48px" }}>
        ...
        <h1 style={{ fontFamily: "Playfair Display, serif", fontWeight: 700, fontSize: "clamp(32px, 4vw, 48px)", color: "#1A1A18", marginBottom: 8 }}>Privacy Policy</h1>
        ...
        {sections.map((s, i) => (
          <div key={i} style={{ marginBottom: 40, paddingBottom: 40, borderBottom: "1px solid rgba(26,26,24,0.08)" }}>
