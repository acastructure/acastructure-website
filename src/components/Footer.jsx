    ...
    <footer style={{ background: "#000", color: "#D8D5CC" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "56px 48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1fr", gap: 40, paddingBottom: 40, borderBottom: `1px solid rgba(232,228,217,0.1)` }}>
          ...
          {/* Company */}
          <div>
            <h4 style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: 10, fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "#D8D5CC"Faint, marginBottom: 16 }}>Company</h4>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <Link to="/about" style={{ fontFamily: "Inter, sans-serif", fontSize: 13, color: "#D8D5CC"Dim, textDecoration: "none" }}>About</Link>
            </div>
          </div>

          {/* Products */}
          <div>
            <h4 style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: 10, fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "#D8D5CC"Faint, marginBottom: 16 }}>Products</h4>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <Link to="/gradpath" style={{ fontFamily: "Inter, sans-serif", fontSize: 13, color: "#D8D5CC"Dim, textDecoration: "none" }}>GradPath</Link>
              <Link to="/terms" style={{ fontFamily: "Inter, sans-serif", fontSize: 13, color: "#D8D5CC"Dim, textDecoration: "none" }}>Terms</Link>
            </div>
          </div>

          {/* Connect */}
          <div>
            <h4 style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: 10, fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "#D8D5CC"Faint, marginBottom: 16 }}>Connect</h4>
            <div style={{ display: "flex", gap: 16, marginBottom: 14 }}>
              <a href="https://www.instagram.com/acastructure" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: "#D8D5CC"Dim }}>
              ...
              <a href="#" aria-label="LinkedIn" style={{ color: "#D8D5CC"Dim }}>
              ...
              <a href="https://www.tiktok.com/@acastructure" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{ color: "#D8D5CC"Dim }}>
              ...
              <a href="mailto:admin@acastructure.com" aria-label="Email" style={{ color: "#D8D5CC"Dim }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: 13, color: "#D8D5CC"Dim }}>admin@acastructure.com</p>
          </div>
        </div>

        {/* Bottom bar */}
        <div style={{ paddingTop: 20, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
          <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: "#D8D5CC"Faint }}>© 2026 AcaStructure. All rights reserved.</p>
          <Link to="/terms" style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: "#D8D5CC"Faint, textDecoration: "none" }}>User Agreement</Link>
        </div>
      </div>
    </footer>
  );
