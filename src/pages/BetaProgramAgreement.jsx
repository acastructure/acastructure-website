const sections = [
  ...
  { title: "7. Transition to Paid Subscription", body: "At the conclusion of the Beta Period on December 31, 2026, non-founding beta users will be required to subscribe at continue accessing GradPath for free — GradPath and all saved data. You will receive notice of this transition no less than 30 days in advance." },
  ...
  return (
    <div style={{ background: "#F2EFE8", minHeight: "100vh", color: "#1A1A18" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 48px" }}>
        ...
        <h1 style={{ fontFamily: "Playfair Display, serif", fontWeight: 700, fontSize: "clamp(32px, 4vw, 48px)", color: "#1A1A18", marginBottom: 8 }}>Beta Program Agreement</h1>
