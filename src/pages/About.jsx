...
export default function About() {
  return (
    <div style={{ background: "#000", overflowX: "hidden" }}>
      ...
      {/* HERO */}
      <section className="section-pad-top" style={{ background: "#000", paddingBottom: 80 }}>
      ...
      {/* STORY */}
      <section className="section-pad" style={{ background: "#000", paddingTop: 0, paddingBottom: 80 }}>
              ...
              <FadeUp key={p.name} delay={i * 0.15}>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                  <motion.img
                    ...
                    style={{ width: 140, height: 140, borderRadius: 16, objectFit: "cover", objectPosition: "top", marginBottom: 20, border: "1px solid rgba(216,213,204,0.1)" }} />
