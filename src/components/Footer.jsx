        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
              <Link to="/" style={{ display: "inline-block", transition: "filter 0.2s, transform 0.2s" }}
                onMouseEnter={e => { e.currentTarget.style.filter = "drop-shadow(0 0 8px rgba(216,213,204,0.35))"; e.currentTarget.style.transform = "translateY(-1px)"; }}
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <Link to="/gradpath" style={linkStyle} onMouseEnter={hoverLink} onMouseLeave={leaveLink}>GradPath</Link>
            </div>
          </div>
